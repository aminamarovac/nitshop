      ...
      <Grid container direction="row">
        <Grid item xs={12} sm={6} md={6} lg={6}>
          ...
          >
            ...
            />
            <Text  fontFamily={fontFamily.LatoRegular} fontSize={fontSize.small}>+38163333333</Text>
            <CustomDiv
              display="flex"
              alignItems="center"
            ...
            >
              ...
              />
              <Text  fontFamily={fontFamily.LatoRegular} fontSize={fontSize.small}>info@mail.com</Text>
            </CustomDiv>
          </CustomDiv>
        </Grid>
